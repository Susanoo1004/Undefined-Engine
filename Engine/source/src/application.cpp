...
void Application::Update()
{
    ...
    glBindTexture(GL_TEXTURE_2D, ResourceManager::resourceManager.Get<Texture>("../Undefined/assets/viking_room.png")->GetID());
...
void Application::InitVikingRoom()
{
    ...
    std::shared_ptr<Model> model = ResourceManager::resourceManager.Get<Model>("../Undefined/assets/viking_room.obj");
...
{
    glBindVertexArray(mVAO);
    glDrawArrays(GL_TRIANGLES, 0, (GLsizei)ResourceManager::resourceManager.Get<Model>("../Undefined/assets/viking_room.obj")->vertexBuffer.size());
}
